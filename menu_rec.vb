...
Public Class menu_rec
    ...
    Private Sub menu_rec_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub lbl_nome_Click(sender As Object, e As EventArgs) Handles lbl_nome.Click

    End Sub

    Private Sub btn_hospedes_Click_1(sender As Object, e As EventArgs) Handles btn_hospedes.Click
        hospedes.Show()
    End Sub

    Private Sub btn_reservas_Click_1(sender As Object, e As EventArgs) Handles btn_reservas.Click
        reservas.Show()
    End Sub
